...
1. ignore the generated files in `.gitignore`:

```gitignore
# icon generated by Icons Launcher
...
2. remove the files from the git cache:
```bash
...
# or 
git rm --cached android/app/src/main/res/mipmap-*/ic_launcher.png
```
